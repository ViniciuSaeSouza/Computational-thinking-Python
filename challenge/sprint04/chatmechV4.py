...
A usabilidade e consistência dos dados devem ser melhoradas no geral. ✔️

Meio estranho na edição do veículo digitar a placa e permitir alterar o modelo do carro. 
Não é legal pedir para o usuário digitar palavras (como sair) para executar um fluxo. 
Agendou para o dia 31.02 "Serviço agendado para 31/2 às 22:12"..
"""
